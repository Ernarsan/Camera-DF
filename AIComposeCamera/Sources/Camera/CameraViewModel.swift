...
extension CameraViewModel: AVCapturePhotoCaptureDelegate {
    ...
    nonisolated func photoOutput(
        ...
        Task { @MainActor [weak self] in
            ...
            // 0. AI Neural Clarity & Super Resolution (Applied to ALL photos for razor-sharp results)
            let processedRaw = AIZoomEnhancer.enhance(image: rawImage, zoomFactor: self.currentZoomFactor)
